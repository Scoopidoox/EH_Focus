...
<html lang="fr">
    ...
    <body>
        ...
        <section>
            ...
            <?php
                $EH_urlId = $_GET["id"] ?? 1;
                $EH_requete = "SELECT idArticle, titreArticle, srcImage FROM article as A INNER JOIN images as I ON A.idImage=I.idImage ORDER BY dateArticle ASC LIMIT 3";
                ...
                while ($EH_ligne) {
                    echo "
                        <a href='./pages/EH_article.php?idArticle=" . $EH_ligne["idArticle"] . "'>
